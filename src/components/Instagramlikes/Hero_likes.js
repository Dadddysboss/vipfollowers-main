...
//                       </strong>
//                       <strike style={{text      }}>${likes?likes.actualPrice:1.47}</strike>
//                     </div>
...
export default function Hero_likes() {
    const [actualPrice,seActualPrice]=useState(1.99);
    const [price,setPrice]=useState(1.47);
    ...
    <div className="shell">
      <div className="hero__inner">
        ...
        <div className="hero__content">
          <div className="hero__text">
            <h1>
              Buy Instagram Likes <br className="hidden-xs" /> with{" "}
              <span className="orange-highlight">Instant Delivery</span>
              <span role="img" aria-label="thunderbolt">
                ⚡
              </span>
            ...
            <p>
              Vip Followers allows you to safely boost the likes on your
              <br className="hidden-xs" />
              ...
              <motion.div className="slider__container embla__container is-draggable"
               ...
               dragConstraints={{
                ...
                >
                  ...
                  <div className="slider__slide embla__slide"
                  onClick={func_Move7}>
                    <div className={`plan   ${border===7?"is-active":""}`}>
                      <div className="plan__inner">
                        <div className="plan__bar">
                          <span style={{ width: "75%" }} />
                          <i>Save 75%</i>
                  ...
                  <div className="slider__slide embla__slide"
                  onClick={func_Move8}>
                    <div className={`plan   ${border===8?"is-active":""}`}>
                      <div className="plan__inner">
                        <div className="plan__bar">
                          <span style={{ width: "75%" }} />
                          <i>Save 78%</i>
